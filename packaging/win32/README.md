...
.\build.ps1 -Name icons-humbleicons -Version 1.2.3
```
...
```
<project>/.config/icons-humbleicons/<packaging>.build-host
$HOME/.config/icons-humbleicons/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/icons-humbleicons
```
